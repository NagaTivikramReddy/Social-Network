# Generated by Django 3.2.4 on 2021-08-18 08:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='', upload_to='posts/images')),
                ('created_at', models.DateTimeField(auto_now=True)),
                ('temp', models.CharField(blank=True, max_length=10, null=True)),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groupposts', to='groups.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commentpost', to='posts.post')),
